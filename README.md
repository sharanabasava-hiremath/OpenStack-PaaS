• Built a Cloud Based Platform-as-a-Service (PaaS) using OpenStack, an opensource Cloud OS which enables the on demand provisioning of Virtual Machines(VMs).
